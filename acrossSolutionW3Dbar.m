...
%% we compared R of Ws for R leg across solutions Reported Values to R values
%symmetric for right leg
% C(speed,asym,stepwidth)
%speed 0.8  to  1.2  to  1.45
%asym   0   to  15%  to   30#
%width normal  wider     wider
data1=importdata("W_Rightcomparison_to_110_solutions.xls");
...
sgtitle('across sol W comparison','Color','red')
