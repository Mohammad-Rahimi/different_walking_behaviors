...
initialguess="14500normalsecond"
solutionname="145001_mat"
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  Options and settings
%% asymmetry target and weight
asymmetrygoal=0    % set this to 1 for applying step length asymmetry goal
targetasym=0.3;   % asymmetry level 
asyweight=175;     % weight of the asymmetry goal
strideLen=1.4;    % this should be assigned when applying step length asymmetry the value depends on the walking speed
...
track.set_final_time(track_final_time);                                              % Final time [s], comment out to optimize movement duration
...
data0(5,1)="target asym";
data0(5,2)=targetasym;
data0(6,1)="asym_weight";
data0(6,2)=asyweight;
data0(7,1)="Step Time Asymmetry";
data0(7,2)=stepTimeAsymmetry;
data0(8,1)="stepLengthAsymmetry";
data0(8,2)=stepLengthAsymmetry;
data0(9,1)="Right Step Length";
data0(9,2)=rightStepLength;
data0(10,1)="left Step Length";
data0(10,2)=leftStepLength;
data0(11,1)="num_iter";
data0(11,2)=gaitTrackingSolution.getNumIterations;
data0(12,1)="solver duration";
data0(12,2)=gaitTrackingSolution.getSolverDuration;
data0(13,1)="track final time";
data0(13,2)=track_final_time;
data0(14,1)="study final time";
data0(14,2)=study_final_time;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
